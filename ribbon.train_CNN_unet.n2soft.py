...
def runNN(train_files,valid_files,test_files):
    ...
    weights_dir = os.path.dirname("../weights/weights.brown.d2560/nohull_004/")
    ...
    model.save_weights(os.path.join(weights_dir,'weights.set{0:03d}.epochs{1:04d}.FINAL.h5'.format(set_nb,(epochs_running+epochs_per_set))),overwrite=True)
