...
#PBS -l feature=k80
#PBS -o $HOME/histo/weights/spatial/drop_000/decay_000/epochs_500/out/$(USER)_$(JOBID)_$(JOBNAME).out
#PBS -e $HOME/histo/weights/spatial/drop_000/decay_000/epochs_500/out/rpizarro_${MOAB_JOBID}_ribbon.err
