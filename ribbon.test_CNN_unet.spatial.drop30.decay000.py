...
def testNN(slice_fn,segment_fn,hull_fn,nb_tiles_in,drop,decay,verbose=False):
    ...
    save_dir=os.path.dirname('/home/rpizarro/histo/prediction/spatial/drop_{0:03d}/decay_{1:03d}/epochs_500/'.format(int(100*drop),int(decay)))
...
print('\n==Testing NN UNET ==\n')
nb_tiles=120
for slice_fn,segment_fn in files[3:]:
