...
def save_to_nii(data,fn):
    out_dir='/data/shmuel/shmuel1/rap/histo/prediction/subcortex/20180125_hull/0859/'
...
def testNN(files,nb_tiles_in,verbose=False):
    ...
    for l,line in enumerate(files):
        try:
            ...
            plt.savefig('/data/shmuel/shmuel1/rap/histo/prediction/subcortex/20180125_hull/0859/'+fn)
            plt.close()
...
slices_fn = grab_files(data_path,"*0859.jpg.nii.gz")
segments_fn = grab_files(data_path,"003_subcortex_cerebellum/0859-segmented.nii")
