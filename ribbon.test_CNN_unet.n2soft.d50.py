...
def save_to_nii(data,fn):
    out_dir='/home/rpizarro/histo/prediction/drop/20180522_hull/drop_050'
...
def testNN(slice_fn,segment_fn,hull_fn,nb_tiles_in,drop,verbose=False):
    ...
    plt.savefig(os.path.join('/home/rpizarro/histo/prediction/drop/20180522_hull/drop_050',fn))
    plt.close()
