...
def runNN(train_files,valid_files,test_files,drop,decay):
    ...
    model_FINAL_fn = os.path.join(weights_dir,'weights.set{0:03d}.epochs{1:04d}.FINAL.h5'.format(set_nb,epochs_running+epochs_per_set))
...
# /home/rpizarro/histo/weights/spatial/drop_000/decay_050/epochs_500/out
