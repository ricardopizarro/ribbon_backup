...
def save_to_nii(data,fn):
    out_dir='/home/rpizarro/histo/prediction/drop/20180522_hull/drop_070'
...
def testNN(slice_fn,segment_fn,hull_fn,nb_tiles_in,drop,verbose=False):
    ...
    weights_fn=os.path.join(weights_dir,'weights.set063.epochs6400.FINAL.h5') 
    ...
    plt.savefig(os.path.join('/home/rpizarro/histo/prediction/drop/20180522_hull/drop_070',fn))
    plt.close()
...
# pause while other script is finalizing
time.sleep(4000)
